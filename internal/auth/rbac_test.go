...
func TestHasPermission(t *testing.T) {
	tests := []struct {
		...
		{store.OrgRoleViewer, "/sevitout.v1.ConfigService/CreateNotificationConfig", false},
		{store.OrgRoleViewer, "/sevitout.v1.ConfigService/UpdateNotificationConfig", false},
		{store.OrgRoleViewer, "/sevitout.v1.ConfigService/DeleteNotificationConfig", false},
		{store.OrgRoleIncidentCommander, "/sevitout.v1.ConfigService/CreateNotificationConfig", false},
		{store.OrgRoleAdmin, "/sevitout.v1.ConfigService/CreateNotificationConfig", true},
		{store.OrgRoleAdmin, "/sevitout.v1.ConfigService/UpdateNotificationConfig", true},
		{store.OrgRoleAdmin, "/sevitout.v1.ConfigService/DeleteNotificationConfig", true},
		{store.OrgRoleViewer, "/sevitout.v1.ConfigService/TestNotificationConfig", false},
		{store.OrgRoleIncidentCommander, "/sevitout.v1.ConfigService/TestNotificationConfig", false},
		{store.OrgRoleAdmin, "/sevitout.v1.ConfigService/TestNotificationConfig", true},
